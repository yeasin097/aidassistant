...
function divisionsList() {
    ...
    var diviList = document.getElementById('editdivision').value;
    ...
    document.getElementById("editdistrict").innerHTML = disctList;
}

// Thana Section select
function thanaList() {
    var DisList = document.getElementById('editdistrict').value;
    if (DisList == 'Bagerhat') {
    ...
    document.getElementById("editthana").innerHTML = thanaList;
}
function clear_location() {
    let temp = document.getElementById("editdivision");
    temp.value = temp.options[0].value;
    divisionsList();
    temp = document.getElementById("editdistrict");
    temp.innerHTML = '<option value = "" disabled selected>Select division first</option>';
    thanaList();
    temp = document.getElementById("editthana");
